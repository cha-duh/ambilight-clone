...
public class proc_20SectionAmbilight extends PApplet {
...
public void draw()
{
 ...
 for (int i=4*displayWidth/8; i<5*displayWidth/8; i=i+2) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "proc_20SectionAmbilight" };
    if (passedArgs != null) {
